...
class Settings:
    ...
    benefit_rag_backend: str = os.getenv("BENEFIT_RAG_BACKEND", "local")
    benefit_embedding_backend: str = os.getenv("BENEFIT_EMBEDDING_BACKEND", "local")
    demo_card_product: str = os.getenv("DEMO_CARD_PRODUCT", "톡톡 with카드")
