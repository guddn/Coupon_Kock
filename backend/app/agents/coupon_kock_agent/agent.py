...
3. 매칭된 canonical_brand와 입력의 card_product로 load_user_benefit_context를 호출한다.
4. 프로필, canonical_brand, 매장 category로 retrieve_official_benefit_rules를 호출한다.
...
- 카드·통신사 rules가 비어 있으면 적용 근거 없음 또는 검색 오류 상태를 표시하고 임의 할인을 만들지 않는다.
